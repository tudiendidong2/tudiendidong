...
//add bai hat
    private void AddSong() {
        ...
        arraySong.add(new Song("Gap em dung luc", R.raw.gapemdungluc));
        arraySong.add(new Song("Mat troi be con", R.raw.mattroibecon));
        arraySong.add(new Song("Stay with me",R.raw.staywithme));
        arraySong.add(new Song("Yeu ban duoc khong",R.raw.yeubanduockhong));
